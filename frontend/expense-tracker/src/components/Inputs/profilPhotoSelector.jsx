...
const profilPhotoSelector = ({image,setImage}) => {
  ...
  return (
    <div className='mb-5'>
        ...
        />
        {!image ? (
            <div className='w-20 h-20 flex items-center justify-center rounded-full bg-purple-100 relative cursor-pointer '>
                <LuUser className="text-4xl text-primary cursor-default" />
                <button
                type='button'
